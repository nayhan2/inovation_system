...
// Anda bisa memindahkan ini ke file terpisah (misal: lib/data.ts)
const explorationData: Record<string, { name: string; videoUrl: string }> = {
  "gunung-rinjani": {
    name: "Gunung Rinjani",
    videoUrl: "https://www.youtube.com/embed/6i3r2H7yG5M", // Contoh video drone
  },
  "kota-tua-jakarta": {
    name: "Kota Tua Jakarta",
    videoUrl: "https://www.youtube.com/embed/a-s01i-c-E8", // Contoh video walking tour
  },
  "raja-ampat": {
    name: "Raja Ampat",
    videoUrl: "https://www.youtube.com/embed/N-a-2a-NHeQ", // Contoh video drone
  },
};
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <Link
            href="/#destinations" // Kembali ke section destinasi di homepage
            scroll={false}
        ...
        >
          Demo Eksplorasi: <span className="text-blue-400">{data.name}</span>
        </motion.h1>
